...
| 2026-09-26 | **Mirada 17-quinquies** — `permisos.html` y `sesion.html` (sprint 2 · la pantalla) · `honestidad.html` (sprint 2) · `banda.html` (ficha · la trajo la pantalla · esperando, con las teclas `⌃⌥`) — *la segunda vuelta de la 17-quater* | **presentada, pendiente del veredicto del usuario** | Fase 3: las pantallas de la lectura de pantalla y los 7 campos |
