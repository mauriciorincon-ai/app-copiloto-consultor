...
| 2026-09-26 | **Mirada 17-ter** — `banda.html` (radar · te graban) · `kit.html` (§ 7, alerta del radar) — la frase **«Ese bot no es Angel Ghost, que nunca entra a la llamada»** | **presentada, pendiente del veredicto del usuario** | Fase 4: el radar (C14) |
