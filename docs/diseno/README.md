...
| 2026-09-26 | **Mirada 17** — `banda.html` (radar ámbar, radar coral y su ampliada) · `sesion.html` (sprint 2 · pista caída) · `permisos.html` (sprint 2 · la pantalla) — *algo falla o algo vigila* | **presentada, pendiente del veredicto del usuario** | Fase 3: la pantalla (C8) |
| 2026-09-26 | **Mirada 17-bis** — `banda.html` (la ficha con su motivo y su latencia, la ficha con sección conjeturada, el transcript con la duración) · `idioma.html` (sprint 2, y sin motor) · `corpus.html` (sprint 2) — *la app se explica a sí misma* | **presentada, pendiente del veredicto del usuario** | Fase 3: los diez campos del contrato sin lector |
