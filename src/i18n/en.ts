...
export const en: Diccionario = {
  banda: {
    ...
    // ---- sprint 002, phase 4: the radar (C14) ---------------------------------------------------
    radarGrabadaYBot: "Meeting recorded · note-taking bot present",
    radarGrabada: "Meeting recorded",
    ...
    radarTeMira: "A program on your Mac is watching you",
    radarCatalogo: "catalogue",
    radarEnTuEquipo: "on your Mac, not the client’s",
    radarQueVe: "what it sees",
    radarSigueProtegida: "your band stays protected",
    radarEnRed: "out",
    radarNadaPersiste: "nothing persists",
    radarVerQueVe: "See what it can see",
    radarCortaTodo: "Cut everything",
    radarClases: {
      supervision: "exam proctoring",
      "anti-trampa": "anti-cheat with system access",
      monitoreo: "employee monitoring",
    ...
    muestra: {
      ...
      radarVe: "sees your full screen and your camera",
    },
  },
  ...
  cuaderno: {
    ...
    vigilanciaTitulo: "Invasive software running on your Mac",
    vigilanciaNoEs: "This is not a meeting recording: these are programs watching",
    vigilanciaTuEquipo: "your machine",
    vigilanciaQueMiran: "— your screen, camera, keystrokes or processes. The radar watches",
    vigilanciaSoloTuMac: "only your Mac",
    vigilanciaJamas: ", never the other party’s computer. A notice so you can decide, not a block.",
    queEncontro: "what it found",
    queAlcanzaAVer: "what it can see",
    nivel: "level",
    catalogo: "catalog",
    invasivo: "Invasive",
    sabelo: "Be aware",
    ...
    radarClases: {
      supervision: { titulo: "Exam proctoring", sufijo: "" },
      "anti-trampa": { titulo: "Anti-cheat with system access", sufijo: "" },
      monitoreo: { titulo: "Employee monitoring", sufijo: "" },
      "acceso-remoto": { titulo: "Active remote access", sufijo: "" },
      mdm: { titulo: "Third-party device management", sufijo: "(MDM)" },
    },
    muestraRadar: {
      supervision: { nombre: "ProctorLince (ejemplo)", alcance: "Camera, full screen, open apps; can block programs" },
      "anti-trampa": { nombre: "GuardKernel (ejemplo)", alcance: "Processes and memory of the whole machine, from the system kernel" },
      monitoreo: { nombre: "VigilaAgente (ejemplo)", alcance: "Screenshots every few minutes, time per app, sometimes keystrokes" },
      "acceso-remoto": { nombre: "RemotoYa (ejemplo)", alcance: "Someone could be watching your screen right now" },
      mdm: { nombre: "MDM-Corp (ejemplo)", alcance: "Can install, wipe and read configuration. Normal on company machines" },
    },
  },
};
